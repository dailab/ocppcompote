...
from compote.eroaming.models.e_roaming_pull_evse_status_by_id import ERoamingPullEVSEStatusByID
from compote.eroaming.models.e_roaming_pull_evse_status_by_operator_id import ERoamingPullEVSEStatusByOperatorID
...
EROAMINGPULLEVSESTATUSV21REQUEST_ONE_OF_SCHEMAS = ["ERoamingPullEVSEStatus", "ERoamingPullEVSEStatusByID", "ERoamingPullEVSEStatusByOperatorID"]

class ERoamingPullEvseStatusV21Request(BaseModel):
    """
    ERoamingPullEvseStatusV21Request
    """
    # data type: ERoamingPullEVSEStatus
    oneof_schema_1_validator: Optional[ERoamingPullEVSEStatus] = None
    # data type: ERoamingPullEVSEStatusByID
    oneof_schema_2_validator: Optional[ERoamingPullEVSEStatusByID] = None
    # data type: ERoamingPullEVSEStatusByOperatorID
    oneof_schema_3_validator: Optional[ERoamingPullEVSEStatusByOperatorID] = None
    actual_instance: Optional[Union[ERoamingPullEVSEStatus, ERoamingPullEVSEStatusByID, ERoamingPullEVSEStatusByOperatorID]] = None
    one_of_schemas: List[str] = Literal["ERoamingPullEVSEStatus", "ERoamingPullEVSEStatusByID", "ERoamingPullEVSEStatusByOperatorID"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ERoamingPullEvseStatusV21Request.model_construct()
        error_messages = []
        match = 0
        # validate data type: ERoamingPullEVSEStatus
        if not isinstance(v, ERoamingPullEVSEStatus):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ERoamingPullEVSEStatus`")
        else:
            match += 1
        # validate data type: ERoamingPullEVSEStatusByID
        if not isinstance(v, ERoamingPullEVSEStatusByID):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ERoamingPullEVSEStatusByID`")
        else:
            match += 1
        # validate data type: ERoamingPullEVSEStatusByOperatorID
        if not isinstance(v, ERoamingPullEVSEStatusByOperatorID):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ERoamingPullEVSEStatusByOperatorID`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ERoamingPullEvseStatusV21Request with oneOf schemas: ERoamingPullEVSEStatus, ERoamingPullEVSEStatusByID, ERoamingPullEVSEStatusByOperatorID. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ERoamingPullEvseStatusV21Request with oneOf schemas: ERoamingPullEVSEStatus, ERoamingPullEVSEStatusByID, ERoamingPullEVSEStatusByOperatorID. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into ERoamingPullEVSEStatus
        try:
            instance.actual_instance = ERoamingPullEVSEStatus.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into ERoamingPullEVSEStatusByID
        try:
            instance.actual_instance = ERoamingPullEVSEStatusByID.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into ERoamingPullEVSEStatusByOperatorID
        try:
            instance.actual_instance = ERoamingPullEVSEStatusByOperatorID.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ERoamingPullEvseStatusV21Request with oneOf schemas: ERoamingPullEVSEStatus, ERoamingPullEVSEStatusByID, ERoamingPullEVSEStatusByOperatorID. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ERoamingPullEvseStatusV21Request with oneOf schemas: ERoamingPullEVSEStatus, ERoamingPullEVSEStatusByID, ERoamingPullEVSEStatusByOperatorID. Details: " + ", ".join(error_messages))
        else:
            return instance
