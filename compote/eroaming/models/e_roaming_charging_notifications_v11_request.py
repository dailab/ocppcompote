...
from compote.eroaming.models.e_roaming_charging_notification_error import ERoamingChargingNotificationError
...
EROAMINGCHARGINGNOTIFICATIONSV11REQUEST_ONE_OF_SCHEMAS = ["ERoamingChargingNotificationEnd", "ERoamingChargingNotificationError", "ERoamingChargingNotificationProgress", "ERoamingChargingNotificationStart"]

class ERoamingChargingNotificationsV11Request(BaseModel):
    """
    ERoamingChargingNotificationsV11Request
    """
    # data type: ERoamingChargingNotificationStart
    oneof_schema_1_validator: Optional[ERoamingChargingNotificationStart] = None
    # data type: ERoamingChargingNotificationProgress
    oneof_schema_2_validator: Optional[ERoamingChargingNotificationProgress] = None
    # data type: ERoamingChargingNotificationEnd
    oneof_schema_3_validator: Optional[ERoamingChargingNotificationEnd] = None
    # data type: ERoamingChargingNotificationError
    oneof_schema_4_validator: Optional[ERoamingChargingNotificationError] = None
    actual_instance: Optional[Union[ERoamingChargingNotificationEnd, ERoamingChargingNotificationError, ERoamingChargingNotificationProgress, ERoamingChargingNotificationStart]] = None
    one_of_schemas: List[str] = Literal["ERoamingChargingNotificationEnd", "ERoamingChargingNotificationError", "ERoamingChargingNotificationProgress", "ERoamingChargingNotificationStart"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ERoamingChargingNotificationsV11Request.model_construct()
        error_messages = []
        match = 0
        # validate data type: ERoamingChargingNotificationStart
        if not isinstance(v, ERoamingChargingNotificationStart):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ERoamingChargingNotificationStart`")
        else:
            match += 1
        # validate data type: ERoamingChargingNotificationProgress
        if not isinstance(v, ERoamingChargingNotificationProgress):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ERoamingChargingNotificationProgress`")
        else:
            match += 1
        # validate data type: ERoamingChargingNotificationEnd
        if not isinstance(v, ERoamingChargingNotificationEnd):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ERoamingChargingNotificationEnd`")
        else:
            match += 1
        # validate data type: ERoamingChargingNotificationError
        if not isinstance(v, ERoamingChargingNotificationError):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ERoamingChargingNotificationError`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ERoamingChargingNotificationsV11Request with oneOf schemas: ERoamingChargingNotificationEnd, ERoamingChargingNotificationError, ERoamingChargingNotificationProgress, ERoamingChargingNotificationStart. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ERoamingChargingNotificationsV11Request with oneOf schemas: ERoamingChargingNotificationEnd, ERoamingChargingNotificationError, ERoamingChargingNotificationProgress, ERoamingChargingNotificationStart. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into ERoamingChargingNotificationStart
        try:
            instance.actual_instance = ERoamingChargingNotificationStart.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into ERoamingChargingNotificationProgress
        try:
            instance.actual_instance = ERoamingChargingNotificationProgress.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into ERoamingChargingNotificationEnd
        try:
            instance.actual_instance = ERoamingChargingNotificationEnd.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into ERoamingChargingNotificationError
        try:
            instance.actual_instance = ERoamingChargingNotificationError.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ERoamingChargingNotificationsV11Request with oneOf schemas: ERoamingChargingNotificationEnd, ERoamingChargingNotificationError, ERoamingChargingNotificationProgress, ERoamingChargingNotificationStart. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ERoamingChargingNotificationsV11Request with oneOf schemas: ERoamingChargingNotificationEnd, ERoamingChargingNotificationError, ERoamingChargingNotificationProgress, ERoamingChargingNotificationStart. Details: " + ", ".join(error_messages))
        else:
            return instance
