...
from compote.eroaming.apis.e_roaming_authorization_api_base import \
    BaseERoamingAuthorizationApi
...
class BaseERoamingAuthorizationImpl(BaseERoamingAuthorizationApi):
    ...
    async def e_roaming_authorize_remote_start_v2_1(
        ...
        payload = e_roaming_authorize_remote_start.dict(by_alias=True, exclude_none=True)
    ...
    async def e_roaming_authorize_remote_stop_v2_1(
        ...
        payload = e_roaming_authorize_remote_stop.dict(by_alias=True, exclude_none=True)
    ...
    async def e_roaming_authorize_start_v2_1(
        ...
        return ERoamingAuthorizationStart.parse_obj(testdata)
    ...
    async def e_roaming_authorize_stop_v2_1(
        ...
        return ERoamingAuthorizationStop.parse_obj(testdata)
    ...
    async def e_roaming_get_charge_detail_records_v2_2(
        ...
        return ERoamingChargeDetailRecords.parse_obj(testdata)
