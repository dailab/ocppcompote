...
async def e_roaming_push_authentication_data_v2_1(
    ...
    return await BaseERoamingAuthenticationDataApi.subclasses[0]().e_roaming_push_authentication_data_v2_1(providerID, e_roaming_push_authentication_data, context)
