...
async def e_roaming_authorize_remote_start_v2_1(
    ...
    return await BaseERoamingAuthorizationApi.subclasses[0]().e_roaming_authorize_remote_start_v2_1(providerID, e_roaming_authorize_remote_start, context)
...
async def e_roaming_authorize_remote_stop_v2_1(
    ...
    if not BaseERoamingAuthorizationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseERoamingAuthorizationApi.subclasses[0]().e_roaming_authorize_remote_stop_v2_1(externalID, e_roaming_authorize_remote_stop, context)
...
async def e_roaming_authorize_start_v2_1(
    ...
    if not BaseERoamingAuthorizationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseERoamingAuthorizationApi.subclasses[0]().e_roaming_authorize_start_v2_1(operatorID, e_roaming_authorize_start, context)
...
async def e_roaming_authorize_stop_v2_1(
    ...
    if not BaseERoamingAuthorizationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseERoamingAuthorizationApi.subclasses[0]().e_roaming_authorize_stop_v2_1(operatorID, e_roaming_authorize_stop, context)
...
async def e_roaming_charge_detail_record_v2_2(
    ...
    if not BaseERoamingAuthorizationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseERoamingAuthorizationApi.subclasses[0]().e_roaming_charge_detail_record_v2_2(operatorID, e_roaming_charge_detail_record, context)
...
async def e_roaming_get_charge_detail_records_v2_2(
    ...
    if not BaseERoamingAuthorizationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseERoamingAuthorizationApi.subclasses[0]().e_roaming_get_charge_detail_records_v2_2(providerID, e_roaming_get_charge_detail_records, context)
