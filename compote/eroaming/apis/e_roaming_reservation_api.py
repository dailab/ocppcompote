...
async def e_roaming_authorize_remote_reservation_start_v1_1(
    ...
    return await BaseERoamingReservationApi.subclasses[0]().e_roaming_authorize_remote_reservation_start_v1_1(providerID, e_roaming_authorize_remote_reservation_start)
...
async def e_roaming_authorize_remote_reservation_stop_v1(
    ...
    if not BaseERoamingReservationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseERoamingReservationApi.subclasses[0]().e_roaming_authorize_remote_reservation_stop_v1(providerID, e_roaming_authorize_remote_reservation_stop)
