import componentsSchemasQRCodeIdentificationHashedPIN from "./QRCodeIdentificationHashedPIN";
...
const schema = {
  properties: {
    ...
    HashedPIN: {
      anyOf: [
        componentsSchemasQRCodeIdentificationHashedPIN,
        {
          type: "null",
        },
      ],
...
const with$id = {
  $id: "/components/schemas/QRCodeIdentification-Output",
  ...schema,
} as const;
export { with$id };
