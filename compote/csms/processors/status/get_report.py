...
class OCPP20GetReportProcessor(GenericGetReportProcessor):
    ...
    async def process(self, context: Context, request_id: int, component_variable: Optional[List] = None, component_criteria: Optional[List] = None, custom_data: Optional[Dict] = None, **kwargs):
        ...
        result = await context.cp.send_get_report(request_id=request_id, component_variable=component_variable, component_criteria=component_criteria, custom_data=custom_data)
        return result